...
export interface UIStrings {
  ...
  popularServicesBody: string;
  uploadDocuments: string;
  uploadDocumentsBody: string;
  verifyIdentity: string;
  verifyIdentityBody: string;
  submitApplication: string;
  submitApplicationBody: string;
  skipLine: string;
  skipLineBody: string;
  whyPortalTitle: string;
  whyPortalBody: string;
  whySkipLinesTitle: string;
  whySkipLinesBody: string;
  whyFasterProcessingTitle: string;
  whyFasterProcessingBody: string;
  whySecureVerificationTitle: string;
  whyAccessibleServicesTitle: string;
  whyAccessibleServicesBody: string;
